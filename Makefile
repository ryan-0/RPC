...
CPPFLAGS = -g -Wall -Werror -std=c++11 -I$(C150IDSRPC) -I$(C150LIB)
...
clean:
	 rm -f pingstreamclient pingstreamserver idldeclarationtst idl_to_json simplefunctionclient simplefunctionserver *.o *.json *.pyc *.stub.cpp *.proxy.cpp core*
